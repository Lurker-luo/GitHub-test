    ...
    <script type="text/javascript">
    	...
    	function ret(id){
            layer.confirm('还原后首页新闻将在前台显示，确定要这么做吗？', function(){ 
            	location.href="index.php/ParterTrain/operate?cmd=ret&ids="+id;
    		},'提示信息',function(index){
    			layer.close(index); 
        	});
       	}
       	...
       	function del(id){
            layer.confirm('删除首页新闻后将不可恢复，确定要这么做吗？', function(){ 
            	location.href="index.php/ParterTrain/operate?cmd=del&ids="+id;
    		},'提示信息',function(index){
    			layer.close(index); 
        	});
       	}
    	...
    	function ret_all(){
            ...
            layer.confirm('还原后首页新闻将在前台显示，确定要这么做吗？', function(){ 
            	location.href="index.php/ParterTrain/operate?cmd=ret&ids="+ids;
    		},'提示信息',function(index){
    			layer.close(index); 
        	});
       	}       	
       	...
       	function del_all(){
            ...
            layer.confirm('删除首页新闻后将不可恢复，确定要这么做吗？', function(){ 
            	location.href="index.php/ParterTrain/operate?cmd=del&ids="+ids;
    		},'提示信息',function(index){
    			layer.close(index); 
        	});
       	}
