    ...
    <script type="text/javascript">
        ...
        function rubbish(id){
            layer.confirm('删除后新闻将出现在回收站，确定要这么做吗？', function(){ 
                location.href="index.php/PartyWork/operate?cmd=rubbish&ids="+id;
            },'提示信息',function(index){
                layer.close(index); 
            });
        }
        //单个屏蔽
            ...
            layer.confirm('删除后新闻将不会在前台显示，确定要这么做吗？', function(){ 
                location.href="index.php/PartyWork/operate?cmd=pngbi&ids="+id;
            },'提示信息',function(index){
                layer.close(index); 
            });
        }
        ...
        function pb_all(){
            ...
            layer.confirm('屏蔽后新闻将不会在前台显示，确定要这么做吗？', function(){ 
                location.href="index.php/PartyWork/operate?cmd=pingbi&ids="+ids;
            },'提示信息',function(index){
                layer.close(index); 
            });
        }                   
        ...
        function rubbish_all(){
            ...
            layer.confirm('删除后新闻将出现在回收站，确定要这么做吗？', function(){ 
                location.href="index.php/PartyWork/operate?cmd=rubbish&ids="+ids;
            },'提示信息',function(index){
                layer.close(index); 
            });
        }           
    ...
    <div class="admin">
        ...
        <div class="panel admin-panel">
            ...
            <div class="padding border-bottom">
                ...
                <input type="button" class="button button-small border-green" value="添加网站简介" onclick="location.href='index.php/PartyWork/add';" />
                <input type="button" class="button button-small border-red" onclick="rubbish_all();" value="批量删除" />
                <input type="button" class="button button-small border-blue" onclick="location.href='index.php/PartyWork/rubbish';" value="回收站" />
            </div>
                ...
                if ($PartyWork){
                    foreach ($PartyWork as $item){
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="button border-blue button-little" href="index.php/PartyWork/edit?id=<?php echo $item['id']; ?>">修改</a>
                                <a class="button border-red button-little" href="index.php/PartyWork/operate?cmd=rubbish?ids=<?php echo $item['id']; ?>" onclick="{if(confirm('确认删除?')){return true;}return false;}">删除</a>
                            </td>
                        </tr>
                        <?php 
                    }
